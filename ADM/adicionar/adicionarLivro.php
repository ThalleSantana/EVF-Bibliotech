...
<body>
    ...
    <h1>.</h1>
    <form action="../../FUNCIONALIDADES/ADM/add.php" method="post">
        <div class="formulario">
            ...
            <div class="form">
                <div class="inputfield">
                    ...
                    <input type="text" class="input" name="titulo" placeholder="Titulo do Livro" autocomplete="off">
                </div>
                <div class="inputfield">
                    <label>Gêneros:</label>
                    <input type="text" class="input" name="genero" placeholder="Genênos do Livro" autocomplete="off">
                </div>
                <div class="inputfield">
                    <label>Autor(es):</label>
                    <input type="text" class="input" name="autor" placeholder="Autor(es) do Livro" autocomplete="off">
                </div>
                <div class="inputfield">
                    <label>Editora:</label>
                    <input type="text" class="input" name="editora" placeholder="Editora do Livro" autocomplete="off">
                </div>
                <div class="inputfield">
                    <label>Quantidade:</label>
                    <input type="text" class="input" name="quant" placeholder="Quantidade de Livros" autocomplete="off">
                </div>
                <div class="inputfield">
                    <label>Ano de Lançamento:</label>
                    <input type="text" class="input" name="ano" placeholder="Ano de Lançamento do Livro" autocomplete="off">
                </div>
                <div class="inputfield">
                    <label>Capa:</label>
                    <input type="text" class="input" name="capa" placeholder="Link para Capa do Livro" autocomplete="off">
                </div>
                <div class="inputfield">
                    <label>Sinopse:</label>
                    <textarea class="textarea" name="sinopse" placeholder="Sinopse do Livro"></textarea>
                </div>
                <div class="inputfield">
                    <input type="submit" value="Adicionar" class="btn" name="adicionarLivro">
                    <a href="../tabelas/tabelaLivros.php"><input type="button" value="Voltar" class="btn"></a>
                </div>
            </div>
        </div>
    </form>
