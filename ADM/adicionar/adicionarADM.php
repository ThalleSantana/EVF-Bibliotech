        ...
        <div class="formulario">
            ...
            <div class="form">
                <div class="inputfield">
                    <label>Login:</label>
                    <input type="text" class="input" name="login" placeholder="Seu Login" autocomplete="off">
                </div>
                <div class="inputfield">
                    <label>Nome:</label>
                    <input type="text" class="input" name="nome" placeholder="Seu Nome" autocomplete="off">
                </div>
                <div class="inputfield">
                    <label>Senha:</label>
                    <input type="password" class="input" name="senha1" placeholder="Digite Sua Senha" autocomplete="off">
                </div>
                <div class="inputfield">
                    <label>Confirme a Senha:</label>
                    <input type="password" class="input" name="senha2" placeholder="Confirme a Senha" autocomplete="off">
                </div>
                <div class="inputfield">
                    <input type="submit" value="Cadastrar" class="btn" name="ADM">
                    <a href="../tabelas/tabelaADM.php"><input type="button" value="Voltar" class="btn"></a>
                </div>
            </div>
        </div>
    </form>
