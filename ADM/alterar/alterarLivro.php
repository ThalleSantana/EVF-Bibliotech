...
<body>
    ...
    if ($result->num_rows > 0) {
        while ($linha = $result->fetch_assoc()) {
            echo '
                    <form action="../../FUNCIONALIDADES/ADM/verificacao.php?codigo=' . $linha['cod'] . '" method="post">
                    <div class="formulario">
                        ...
                        <div class="form">
                            <div class="inputfield">
                                ...
                                <input type="text" name="titulo" class="input" value="' . $linha['titulo'] . '" autocomplete="off">
                            </div>  
                            <div class="inputfield">
                                <label>Gêneros:</label>
                                <input type="text" name="genero" class="input" value="' . $linha['generos'] . '" autocomplete="off">
                            </div>  
                            <div class="inputfield">
                                <label>Autor(es):</label>
                                <input type="text" name="autor" class="input" value="' . $linha['autor'] . '" autocomplete="off">
                            </div>  
                            <div class="inputfield">
                                <label>Editora:</label>
                                <input type="text" name="editora" class="input" value="' . $linha['editora'] . '" autocomplete="off">
                            </div> 
                            <div class="inputfield">
                                <label>Quantidade:</label>
                                <input type="text" name="quant" class="input" value="' . $linha['quantidade'] . '" autocomplete="off">
                            </div>
                            <div class="inputfield">
                                <label>Ano de Lançamento:</label>
                                <input type="text" name="ano" class="input" value="' . $linha['ano'] . '" autocomplete="off">
                            </div>
                            <div class="inputfield">
                                <label>Capa:</label>
                                <input type="text" name="capa" class="input" value="' . $linha['capa'] . '" autocomplete="off">
                            </div>
                            <div class="inputfield">
                                <label>Sinopse:</label>
                                <textarea class="textarea" name="sinopse">' . $linha['sinopse'] . '</textarea>
                            </div>  
                            <div class="inputfield">
                                <input type="submit" value="Alterar" class="btn" name="alterarLivro">
