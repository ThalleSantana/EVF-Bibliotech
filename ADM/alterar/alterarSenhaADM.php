...
$var = $_GET['login'];
include('../conn.php');
$SQL = "SELECT * FROM adm WHERE Login = '$var'";
                ...
                while ($linha = $result->fetch_assoc()) {
                    echo '
                        <div class="inputfield">
                            <label>Login:</label>
                            <input type="text" class="input cursor" value="' . $linha['Login'] . '" readonly>
                        </div>
                        <div class="inputfield">
                            <label>Senha Nova:</label>
                            <input type="password" class="input" name="senha1" placeholder="Coloque a Senha nova" autocomplete="off">
                        </div>  
                        <div class="inputfield">
                            <label>Confirme a Senha:</label>
                            <input type="password" class="input" name="senha2" placeholder="Confirme a Senha nova" autocomplete="off">
                        </div>   
                        <div class="inputfield">
                            <a href="../tabelas/tabelaADM.php"><input type="submit" value="Alterar" class="btn"></a>
                            <a href="../tabelas/tabelaADM.php"><input type="submit" value="Voltar" class="btn"></a>
                        </div>
                ';
                };
            } else {
