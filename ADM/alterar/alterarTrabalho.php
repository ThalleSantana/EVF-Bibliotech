...
<body>
    ...
    if ($result->num_rows > 0) {
        while ($linha = $result->fetch_assoc()) {
            echo '
                        <form action="../../FUNCIONALIDADES/ADM/verificacao.php?cod=' . $linha['Cod'] . '" method="post">
                            <div class="formulario">
                                ...
                                <div class="form">
                                    <div class="inputfield">
                                        ...
                                        <input type="text" name="nomeTrab" class="input" value="' . $linha['Nome_Trab'] . '" autocomplete="off">
                                    </div>
                                    <div class="inputfield">
                                        <label>Autor(es):</label>
                                        <input type="text" name="autor" class="input" value="' . $linha['Autor_Trab'] . '" autocomplete="off">
                                    </div>  
                                    <div class="inputfield">
                                        <label>Tipo:</label>
                                        <input type="text" name="tipo" class="input" value="' . $linha['Tipo_Trab'] . '" autocomplete="off">
                                    </div>
                                    <div class="inputfield">
                                        <label>Ano de Produção:</label>
                                        <input type="text" name="ano" class="input" value="' . $linha['Ano_Trab'] . '" autocomplete="off">
                                    </div>
                                    <div class="inputfield">
                                        <label>Link:</label>
                                        <input type="text" name="link" class="input" value="' . $linha['Link_Trab'] . '" autocomplete="off">
                                    </div>
                                    <div class="inputfield">
                                        <label>Sinopse:</label>
                                        <textarea class="textarea" name="sinopse">' . $linha['Sinopse_Trab'] . '</textarea>
                                    </div>  
                                    <div class="inputfield">
                                        <input type="submit" value="Alterar" class="btn" name="alterartrab">
