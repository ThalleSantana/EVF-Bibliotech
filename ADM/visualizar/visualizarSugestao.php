                ...
                while ($linha = $result->fetch_assoc()) {
                    echo '
                        <div class="inputfield">
                            ...
                            <input type="text" class="input cursor" value="' . $linha['Titulo_Livro'] . '" readonly>
                        </div>
                        <div class="inputfield">
                            <label>Autor(es):</label>
                            <input type="text" class="input cursor" value="' . $linha['Autor_Livro'] . '" readonly>
                        </div>  
                        <div class="inputfield">
                            <label>RM do Aluno:</label>
                            <input type="text" class="input cursor" value="' . $linha['RM'] . '" readonly>
                        </div>
                        <div class="inputfield">
                            <label>Nome do Aluno:</label>
                            <input type="text" class="input cursor" value="'.$linha['Nome'].'" readonly>
                        </div>
                        <div class="inputfield">
                            <label>Sinopse:</label>
                            <textarea class="textarea cursor" readonly>' . $linha['Sinopse_Livro'] . '</textarea>
                        </div>  
                        <div class="inputfield">
                            <a href="verSugestão.php?codigo='.$linha['Cod'].'"><input type="submit" value="Visão Usuario" class="btn"></a>
                            <a href="../tabelas/tabelaSugestões.php"><input type="submit" value="Voltar" class="btn"></a>
                        </div>
                ';
                };
            } else {
